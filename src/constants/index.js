...
export const fetchPostsUrl = "http://jsonplaceholder.typicode.com/posts";
export const fetchTodosUrl = "http://jsonplaceholder.typicode.com/todos";
export const fetchUsersUrl = "http://jsonplaceholder.typicode.com/users";
